# TGS-GapCloser (Fast and Accurately passing through the Bermuda in Large genOme Using error-prone third-generation-Sequencing long reads)
...
## Citing TGS-GapCloser (TGS-GapCloser)
If you use TGS-GapCloser (also named TGS-GapCloser) in your work, please cite:
